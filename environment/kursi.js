...
function main() {
    ...
    // kursi
    var papan_vertex = [
        -1, -0.95, -0.4,     66/255, 56/255, 43/255, 
        1, -0.95, -0.4,     66/255, 56/255, 43/255,
        1,  -0.8, -0.4,     66/255, 56/255, 43/255,
        -1,  -0.8, -0.4,     66/255, 56/255, 43/255,
        ...
        -1, -0.8, -0.4,    92/255, 59/255, 36/255,
        -1, -0.8,  0.4,    92/255, 59/255, 36/255,
        1, -0.8,  0.4,     92/255, 59/255, 36/255,
        1, -0.8, -0.4,     92/255, 59/255, 36/255,
      ];
    ...
    var tiang1_vertex = [
        -1, -1.4, -0.4,     133/255, 133/255, 133/255, 
        -0.9, -1.4, -0.4,     133/255, 133/255, 133/255,
        -0.9,  -0.95, -0.4,     133/255, 133/255, 133/255,
        -1,  -0.95, -0.4,     133/255, 133/255, 133/255,
    ...
    var kursi = new MyObject(papan_vertex, kursi_faces, shader_vertex_source, shader_fragment_source);
    var tiang1 = new MyObject(tiang1_vertex, kursi_faces, shader_vertex_source, shader_fragment_source);
    var tiang2 = new MyObject(tiang2_vertex, kursi_faces, shader_vertex_source, shader_fragment_source);
    ...
    var animate = function (time) {
        if (time > 0) {
            ...
            kursi.setIdentityMove();        
            kursi.setRotateMove(PHI, THETA, 0);  
            kursi.setTranslateMove(0, 0, 0);

            tiang1.setIdentityMove();        
            tiang1.setRotateMove(PHI, THETA, 0);  
            tiang1.setTranslateMove(0, 0, 0);

            tiang2.setIdentityMove();        
            tiang2.setRotateMove(PHI, THETA, 0);  
            tiang2.setTranslateMove(0, 0, 0);
        ...
        tiang1.setUniformMatrix4(PROJMATRIX, VIEWMATRIX);
        tiang2.setUniformMatrix4(PROJMATRIX, VIEWMATRIX);
