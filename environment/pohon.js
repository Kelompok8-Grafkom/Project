...
function main() {
    ...
    var animate = function (time) {
        if (time > 0) {
            ...
            pohon.setIdentityMove();        
            pohon.setRotateMove(PHI, THETA, 0);  
            pohon.setTranslateMove(0, 0, 0);
