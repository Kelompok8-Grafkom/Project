...
function main() {
    ...
    var generateCone = function (mX, mY, mZ, pX, pY, pZ, r, g, b) {
        var cone_vertex = [];
    ...
    //telinga
    object = generateCone(0.35, -0.05, -1.4, 0.4, 0.4, 0.4, 247, 217, 18);
    ...
    rory_kepala.addChild(telinga_kanan);
    ...
    rory_kepala.addChild(rory_badan);
    rory_kepala.addChild(rory_tangan_kanan);
    rory_kepala.addChild(rory_tangan_kiri);
    rory_kepala.addChild(rory_kaki_kanan);
    rory_kepala.addChild(rory_kaki_kiri);
    rory_kepala.addChild(baju_1);
    rory_kepala.addChild(baju_2_1);
    rory_kepala.addChild(baju_2_2);
    rory_kepala.addChild(baju_3_1);
    rory_kepala.addChild(baju_3_2);
    rory_kepala.addChild(ekor_1);
    rory_kepala.addChild(ekor_2);
    rory_kepala.addChild(ekor_3);
    ...
    var animate = function (time) {
        if (time > 0) {
            ...
            rory_kepala.setIdentityMove();        
            rory_kepala.setRotateMove(PHI, THETA, 0);            

            for (let i = 0; i < rory_kepala.child.length; i++) {
                rory_kepala.child[i].setIdentityMove();
                rory_kepala.child[i].setRotateMove(PHI, THETA, 0);
            }
            ...
            glMatrix.mat4.rotateX(telinga_kanan.MOVEMATRIX, telinga_kanan.MOVEMATRIX, LIBS.degToRad(100));
            glMatrix.mat4.rotateY(telinga_kanan.MOVEMATRIX, telinga_kanan.MOVEMATRIX, LIBS.degToRad(5));
            // glMatrix.mat4.rotateX(baju_depan.MOVEMATRIX, baju_depan.MOVEMATRIX, LIBS.degToRad(180));
        ...
        rory_kepala.setUniformMatrix4(PROJMATRIX, VIEWMATRIX);

        for (let i = 0; i < rory_kepala.child.length; i++) {
            rory_kepala.child[i].setUniformMatrix4(PROJMATRIX, VIEWMATRIX);
        }
        rory_kepala.draw();
        GL.flush();
